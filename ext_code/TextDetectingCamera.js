// Text Detecting Camera Component
// Utilize device camera for text detection and recognition

import React from "react";
import { StyleSheet, Text, View, TouchableOpacity } from "react-native";
import { detectText } from "./api"; // Use AWS Rekognition API when taking picture
...
class TextDetectingCamera extends React.Component {
  ...
  // Utitlize AWS Rekognition w/ Picture Taken
  takePicture = async () => {
